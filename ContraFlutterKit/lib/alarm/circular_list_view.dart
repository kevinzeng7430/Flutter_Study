...
class CircularListView extends StatefulWidget {
  ...
  Widget _backgroundWidget() {
    return Transform(
      transform: Matrix4.translationValues(145.0, 320.0, 0.0),
      child: Container(
        width: 120,
        height: 120,
  ...
  Widget _radialListItem(double angle) {
    return Transform(
      transform: Matrix4.translationValues(215.0, 400.0, 0.0),
      child: CircularPosition(
        radius: radius,
        angle: angle,
        child: const CircularListItem(),
      ),
    );
  }
